...
var MediaCollection = /** @class */ (function () {
    ...
    MediaCollection.prototype.removeMedia = function (itemId) {
        if (itemId) {
            this._collection = this._collection.filter(function (media) { return media.identifier !== itemId; });
        }
    };
    __decorate([
        class_transformer_1.Expose()
...
var MediaServiceImpl = /** @class */ (function () {
    ...
    MediaServiceImpl.prototype.getMediaCollectionIdentifierList = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    MediaServiceImpl.prototype.removeMedialCollection = function (identifier) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (!identifier && '' !== identifier.trim()) {
                reject(new Error("The identifier must be provided!"));
            }
            _this._store.removeItem(identifier.trim())
                .then(function () {
...
var MediaManControllerImpl = /** @class */ (function () {
    function MediaManControllerImpl(view, bookService, movieService) {
        this._bookCollections = new Map(); // <3> 
    ...
    MediaManControllerImpl.prototype.reloadBookCollections = function () {
        var _this = this;
        this._bookService.getMediaCollectionIdentifierList().then(function (keys) {
    ...
    MediaManControllerImpl.prototype.removeBookCollection = function (identifier) {
        ...
        this._bookService.removeMedialCollection(identifier).then(function () {
            console.log("Removed the collection with identifier: ", identifier);
            _this._bookCollections.delete(identifier);
            _this._view.removeBookCollection(identifier);
        }).catch(function (_) {
